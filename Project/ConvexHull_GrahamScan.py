...
if __name__ == "__main__":
    # total_points = 8                                     # Total points to be generated
    # min_coord,max_coord = 0,100                           # Minimum and maximum value a that the coordinate of a point can have 
    # points = generate_points(total_points,min_coord,max_coord) # Generating random points
    # print("\nPoints generated randomly are: ",points
